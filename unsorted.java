	...
	LinkedList<Integer> list =new LinkedList<Integer>();
	 ...
	 public void makeheap(LinkedList<Integer> list,LinkedList<Integer> list2) {   //creating new
		 while(keep==true) {
				...
				else if(choose.equalsIgnoreCase("makeheap")) { //when creating a new list
	 ...
	 public void union(LinkedList<Integer> list1,LinkedList<Integer> list2,LinkedList<Integer> list3) {
		 ...
		 Collections.sort(list3);//sorting o(nlogn)
		 System.out.println(list3);
		    //func from the beginning just without union and makeheap
		  while(keep2==true) {
			    System.out.println("choose-finish,insert,extractmin,printmin,printlist ?");
			    String choose=in.next();
				if(choose.equalsIgnoreCase("insert")) {//insert
					int x=in.nextInt();
				    list3.addLast(x);	
